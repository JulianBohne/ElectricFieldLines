...
public static final int numFieldLinesPerParticle = 12; // You can change this if you want. Doesn't have to be final or static, this is just to make it stand out a bit.
